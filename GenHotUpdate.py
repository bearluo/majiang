...
assetsDir = {
    "searchDir" : ["res_temp"],# "src"],
    "ignorDir" : ["cocos", "obj","version","framework"]
}

versionConfigFile = "version_info.json"  #版本信息的配置文件路径
versionManifestPath = "res_temp/version.manifest"    #由此脚本生成的version.manifest文件路径
projectManifestPath = "res_temp/project.manifest"    #由此脚本生成的project.manifest文件路径
